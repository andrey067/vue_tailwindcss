<template>
    <div class="content-center px-4 py-8 space-x-6 ">
        <h6 class="font-bold">
            Component DropDown
        </h6>
        <div class="max-w-lg mx-auto">
            <button
                ...
                type="button" data-dropdown-toggle="dropdown">Dropdown button <svg class="w-4 h-4 ml-2" fill="none"
            ...
            <p class="mt-5">This dropdown element is part of a larger, open-source library of Tailwind CSS components.
